..
   ...
   ``conf.py``). A use case showcases a published study end to end from bundled
...
one level up: it **showcases a published study** end to end with AAanalysis, so you
...
fast showcase: it highlights the *key results* and the *biology*, and points to
