...
def print_start_progress():
    ...
    progress_bar = " " * 25
    print_green(f"\r   |{progress_bar}| 0.00%", end="")
...
def print_progress(i=0, n=0):
    ...
    print_green(f"\r   |{progress_bar}| {progress:.2f}%", end="")


def print_finished_progress():
    """Print finished progress bar"""
    progress_bar = "#" * 25
    print_green(f"\r   |{progress_bar}| 100.00%")
