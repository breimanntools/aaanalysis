...
def check_model_kwargs(model_class=None, model_kwargs=None,
    ...
    if param_to_check is not None and param_to_check not in valid_args:
        raise ValueError(f"'{param_to_check}' should be an argument in the given 'model' ({model_class}).")
    ...
    if attribute_to_check is not None and not hasattr(model_class, attribute_to_check):
        raise ValueError(f"'{attribute_to_check}' should be an attribute in the given 'model' ({model_class}).")
